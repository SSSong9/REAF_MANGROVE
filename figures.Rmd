...
# Please change it to your own path, where file 'Supplementary Data.csv', 'EEZ_mangroveloss_final.csv',  'Supplementary Data of Fig. S9.csv', 'implement cost.csv' and 'carbonprice.csv' exist.
```
...
P1=ggplot(ABC_select,aes(x=timegroup,y=ABC_mean,color=re_af))+
  ...
  stat_compare_means(size=2,aes(label = ..p.signif..),label.y = 305,hide.ns = TRUE,show.legend = F,
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("P ≤ 0.0001", "P ≤ 0.001", 
                                                    "P ≤ 0.01", "P ≤ 0.05", 
                                                    "ns")))+
...
P2=ggplot(BBC_select,aes(x=timegroup,y=BBC_mean,color=re_af))+
  ...
  stat_summary(fun.data = give.n, geom = "text", fun.y = median, size=1.5,
                   position = position_dodge(width = 0.75))+
  stat_compare_means(size=2,aes(label = ..p.signif..),label.y = 100,hide.ns = TRUE,show.legend = F,
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("P ≤ 0.0001", "P ≤ 0.001", 
                                                    "P ≤ 0.01", "P ≤ 0.05", 
                                                    "ns")))+
...
P3=ggplot(SCS_select,aes(x=timegroup,y=SCS_mean_100,color=re_af))+
  ...
  stat_summary(fun.data = give.n, geom = "text", fun.y = median, size=1.5,
                   position = position_dodge(width = 0.75))+
  stat_compare_means(size=2,aes(label = ..p.signif..),label.y = 480,hide.ns = TRUE,show.legend = F,
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("P ≤ 0.0001", "P ≤ 0.001", 
                                                    "P ≤ 0.01", "P ≤ 0.05", 
                                                    "ns")))+
...
P4=ggplot(TECS_select,aes(x=timegroup,y=TECS_mean,color=re_af))+
  ...
  stat_summary(fun.data = give.n, geom = "text", fun.y = median, size=1.5,
                   position = position_dodge(width = 0.75))+
  stat_compare_means(size=2,aes(label = ..p.signif..),label.y = 510,hide.ns = TRUE,show.legend = F,
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("P ≤ 0.0001", "P ≤ 0.001", 
                                                    "P ≤ 0.01", "P ≤ 0.05", 
                                                    "ns")))+
...
ggsave(path=c("[please change it into your own path]"),
       filename="Fig.2.png",
...
ABC_re$LULCC_before=factor(ABC_re$LULCC_before,
                           levels=c("abandoned agricultural/aquacultural site",
                                    "clearing-cut site","site with mangrove mortality"))
...
P1=ggboxplot(ABC_re,x="LULCC_before",y="ABC_mean",
  ...
  theme(axis.text.x=element_text(hjust = 0.5,colour="white",size=3),
        ...
        legend.title = element_blank())+
  stat_compare_means(comparisons =list(c("abandoned agricultural/aquacultural site", "clearing-cut site"),
                                       c("abandoned agricultural/aquacultural site",
                                         "site with mangrove mortality"),
                                       c("clearing-cut site","site with mangrove mortality")),
                     size=2,aes(label = ..p.signif..),show.legend = F,hide.ns = FALSE,
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("P ≤ 0.0001", "P ≤ 0.001", 
                                                    "P ≤ 0.01", "P ≤ 0.05", 
                                                    "ns")))+
...
DT=dunnTest(rate~timegroup,data=ABC_select,method="bh")
PT=DT$res
...
ggplot(ABC_select,aes(x=timegroup,y=rate))+
  ...
  stat_summary(fun.data = give.n, geom = "text", fun.y = median, size=2.5,
                   position = position_dodge(width = 0.75),color="#326232")+
...
P1=ggplot(ABC_timeMAP,aes(x=timegroup,y=ABC_mean,color=inter))+
  ...
  stat_summary(fun.data = give.n, geom = "text", fun.y = median, size=2,
                   position = position_dodge(width = 0.75),show.legend = F)+
  stat_compare_means(size=2.5,aes(label = ..p.signif..),label.y = 240,hide.ns = TRUE,show.legend = F,
                     method = 'kruskal.test',
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("P ≤ 0.0001", "P ≤ 0.001", 
                                                    "P ≤ 0.01", "P ≤ 0.05", 
...
P2=ggplot(BBC_timeMAP,aes(x=timegroup,y=BBC_mean,color=inter))+
  ...
  stat_summary(fun.data = give.n, geom = "text", fun.y = median, size=2,
                   position = position_dodge(width = 0.75),show.legend = F)+
  stat_compare_means(size=2.5,aes(label = ..p.signif..),label.y =65,hide.ns = TRUE,show.legend = F,
                     method = 'kruskal.test',
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("P ≤ 0.0001", "P ≤ 0.001", 
                                                    "P ≤ 0.01", "P ≤ 0.05", 
...
ggplot(SCS,aes(x=timegroup,y=SCS_increase_all,color=re_af))+
  ...
  stat_summary(fun.data = give.n, geom = "text", fun.y = median, size=2,show.legend = F,
                   position = position_dodge(width = 0.75))+
  stat_compare_means(size=2,aes(label = ..p.signif..),label.y = 180,hide.ns = TRUE,show.legend = F,
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("P ≤ 0.0001", "P ≤ 0.001", 
                                                    "P ≤ 0.01", "P ≤ 0.05", 
                                                    "ns")))+
...
P5=ggboxplot(data_1,x="re_af",y="salinity_pore",
  ...
  theme(axis.text.x=element_text(hjust = 0.5,colour="white",size=3),
        axis.title.x = element_text(hjust = 0.5,colour="white",size=3))+
    scale_color_manual(values = c("reforestation"="#006400","afforestation"="#51C151"))+
  stat_compare_means(size=2,aes(label = ..p.signif..),
                     label.x = 1.2,label.y = 58,hide.ns = TRUE,show.legend = F,
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("P ≤ 0.0001", "P ≤ 0.001", 
                                                    "P ≤ 0.01", "P ≤ 0.05", 
                                                    "ns")))+
...
P6=ggboxplot(data_1,x="re_af",y="SC_mean",
          ...
          add.params = list(size = 0.6, alpha=0.5))+
    scale_color_manual(values = c("reforestation"="#006400","afforestation"="#51C151"))+
  stat_compare_means(size=1.5,aes(label = ..p.signif..),label.x = 1.2,label.y = 20,
...
P7=ggboxplot(data_1,x="re_af",y="N.concentration_mean",
          ...
          add.params = list(size = 0.6, alpha = 0.5))+
    scale_color_manual(values = c("reforestation"="#006400","afforestation"="#51C151"))+
  stat_compare_means(size=1.5,aes(label = ..p.signif..),label.x = 1.2,label.y = 0.75,
                     show.legend = F,hide.ns = TRUE,
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("P ≤ 0.0001", "P ≤ 0.001", 
                                                    "P ≤ 0.01", "P ≤ 0.05", 
...
# function for number of observations 
give.n <- function(x){
  return(data.frame(y = -100, label =  paste('n =', length(x))))
  # experiment with the multiplier to find the perfect position
}
...
P9=ggboxplot(data_1,x="re_af",y="MAP",
  ...
  theme(axis.text.x=element_text(hjust = 0.5,colour="white",size=3),
        axis.title.x = element_text(hjust = 0.5,colour="white",size=3))+
    scale_color_manual(values = c("reforestation"="#006400","afforestation"="#51C151"))+
  stat_compare_means(size=2,aes(label = ..p.signif..),label.x = 1.2,label.y = 58,
                     show.legend = F,hide.ns = TRUE,
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("p ≤ 0.0001", "p ≤ 0.001", 
                                                    "p ≤ 0.01", "p ≤ 0.05", 
...
p6=ggboxplot(data,x="re_af",y="silt",
  ...
  stat_compare_means(size=2.5,label = "p.signif",label.x=1.5,label.y = 85,hide.ns = TRUE,show.legend = F,
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("P ≤ 0.0001", "P ≤ 0.001", 
                                                    "P ≤ 0.01", "P ≤ 0.05", 
                                                    "ns")))+
...
P1=ggboxplot(data,x="re_af",y="initial_SC",
          ...
          legend = "none",
          add.params = list(alpha = 0.5))+
  stat_compare_means(size=2.5,label = "p.signif",label.x=1.5,label.y = 19,hide.ns = TRUE,show.legend = F,
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("P ≤ 0.0001", "P ≤ 0.001", 
                                                    "P ≤ 0.01", "P ≤ 0.05", 
                                                    "ns")))+
...
# function for number of observations 
give.n <- function(x){
  return(data.frame(y = -0.05, label =  paste('n =', length(x))))
  # experiment with the multiplier to find the perfect position
}
...
P2=ggboxplot(data,x="re_af",y="initial_N",
          ...
          legend = "none",
          add.params = list(alpha = 0.5))+
  stat_compare_means(size=2.5,label = "p.signif",label.x=1.5,hide.ns = TRUE,show.legend = F,
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("P ≤ 0.0001", "P ≤ 0.001", 
                                                    "P ≤ 0.01", "P ≤ 0.05", 
                                                    "ns")))+
...
P3=ggboxplot(data,x="re_af",y="initial_CN",
          ...
          legend = "none",
          add.params = list(alpha = 0.5))+
  stat_compare_means(size=2.5,label = "p.signif",label.x=1.5,label.y=39,hide.ns = TRUE,show.legend = F,
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("P ≤ 0.0001", "P ≤ 0.001", 
                                                    "P ≤ 0.01", "P ≤ 0.05", 
                                                    "ns")))+
...
```{r}
### Fig. S9 ###
data=read.csv("Supplementary Data of Fig. S9.csv",stringsAsFactors = FALSE,fileEncoding = 'GB18030')
...
P1=ggplot(data=ABC,aes(x=re_af,y=ABC_mean))+
  ...
  stat_compare_means(size=2.5,aes(label = ..p.signif..),label.x=1.5,show.legend = F,
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("P ≤ 0.0001", "P ≤ 0.001", 
                                                    "P ≤ 0.01", "P ≤ 0.05", 
                                                    "P > 0.5")))+
...
```{r}
### Fig. S7 ###
price=read.csv("carbonprice.csv")
world = ne_countries(scale = "medium", returnclass = "sf")
world_price=merge(world,price,by.x="admin",by.y="country")

onlyfrance=ne_countries(geounit = 'france', type = 'map_units',
                        scale = "medium", returnclass = "sf")

p9=ggplot(data = world_price) +
    geom_sf(data=world,color = "#EEEEEE", fill = "#E3E3E3",lwd=0.3)+
    geom_sf(aes(fill = Com),alpha=0.8,lwd=0.3) +
    geom_sf(data=onlyfrance,color="#EEEEEE",fill="#E3E3E3",lwd=0.3)+
    scale_fill_gradient2(low="#F3CABE",mid="#9B4C35", high="#692410", midpoint = 100, space ="Lab",na.value="white")+
  mytheme+
    theme(
        panel.grid.major =element_blank(), 
        panel.grid.minor = element_blank(),
  ...
  scale_y_continuous(expand = c(0,0),limits = c(-48,55))+
    xlab("Longitude")+
    ylab("Latitude")+
  ggtitle("Total implementation and opportunity cost per megagram of carbon dioxide equivalent mitigated")+
  labs(fill=expression(atop("Mitigation cost",
                                             atop(textstyle(("$ Mg CO"[2]*"-eq"^-1))))))

p1=ggplot(data = world_price) +
    geom_sf(data=world,color = "#EEEEEE", fill = "#E3E3E3",lwd=0.3)+
    geom_sf(aes(fill = NPC),alpha=0.8,lwd=0.3) +
    geom_sf(data=onlyfrance,color="#EEEEEE",fill="#E3E3E3",lwd=0.3)+
  ...
  scale_y_continuous(expand = c(0,0),limits = c(-48,55))+
    xlab("Longitude")+
    ylab("Latitude")+
  ggtitle("Implementation cost per megagram of carbon dioxide equivalent mitigated")+
  labs(fill=expression(atop("Mitigation cost",
                                             atop(textstyle(("$ Mg CO"[2]*"-eq"^-1))))))
  

ggarrange(p1,p9, ncol = 1, nrow =2 ,labels="auto",font.label=list(face="plain",family = "Helvetica",size=7,face="bold"),
             legend ="bottom",common.legend = T)

ggsave(path = "[please change it into your own path]",
       filename="Fig.S7.png",
       width = 130, height = 150, units = "mm",dpi=300)
